...
uses
  ...
  ComCtrls, sComboBoxes, Mask, sMaskEdit, ExtCtrls, sPanel, acPNG, sGauge, pult;
...
procedure play(coins: integer);
begin
  delay(plate(form2.Left, form2.Top, form2.Width, form2.Height), ['1', '2', '3'], 400);
  form2.hide;
  inited := false;
  form1.Show;
...
begin
  ...
  begin
    resetWin;
//    lbl4.Caption := 'Money: ' + IntToNumber(stat.overall.coins);
//    sg1.MaxValue := EXPERIENCE_LEVEL_RANGE;
//    spnl3.Caption := inttostr(round(stat.overall.damage) div EXPERIENCE_LEVEL_RANGE + 1);
//    sg1.Progress := (round(stat.overall.damage) mod EXPERIENCE_LEVEL_RANGE);
  end;
end;
